...
class AnalogClockWidgetClassic_HiRes : AppWidgetProvider() {
    ...
    override fun onUpdate(
        ...
        val dialRaw = BitmapFactory.decodeResource(context.resources, R.drawable.clock_dial_classic, options)
        ...
        for (appWidgetId in appWidgetIds) {
            val views = RemoteViews(context.packageName, R.layout.widget_analog_clock_classic_hires)
