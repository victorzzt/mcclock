...
class AnalogClockWidgetClassic : AppWidgetProvider() {
    ...
    override fun onUpdate(
        ...
        val item = BitmapFactory.decodeResource(context.resources, R.drawable.clock_mask_classic, options)
        val dial = BitmapFactory.decodeResource(context.resources, R.drawable.clock_dial_classic, options)
        ...
        for (appWidgetId in appWidgetIds) {
            val views = RemoteViews(context.packageName, R.layout.widget_analog_clock_classic)
